	  		...
	  		<?php if (esta_logado(FALSE)) { ?>
	  			<div class="row header">
	  				...
	  				<div class="four columns">
	  					<p class="text-right">Logado como <strong><?php echo $this->session->userdata('user_login'); ?></strong></p>
	  					<p class="text-right">
	  						<?php echo anchor('usuarios/alterar_senha/'.$this->session->userdata('user_cod'), 'Alterar senha', 'class="button radius tiny"'); ?>
